...
def main():
    ...
    mc = st.number_input("mc", key="mc", label_visibility="collapsed", value=20.00, format="%.2f")
    ...
    wf = st.number_input("wf", key="wf", label_visibility="collapsed", value=0.250, format="%.3f")
    st.markdown("### Enter hopper inclination angle &Theta; in degrees:", unsafe_allow_html=True)
    ia = st.number_input("ia", key="ia", label_visibility="collapsed", value=30.00, format="%.2f")
    st.markdown("### Enter hopper opening width W in mm:")
    w = st.number_input("w", key="w", label_visibility="collapsed", value=75.00, format="%.3f")
